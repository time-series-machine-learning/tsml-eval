...
script_file_path="$local_path/tsml-eval/tsml_eval/experiments/threaded_clustering_experiments.py"
...
if ((totalThreads>=max_cpus_to_use)); then
...
# Input args to the default threaded_clustering_experiments are in main method of
# https://github.com/time-series-machine-learning/tsml-eval/blob/main/tsml_eval/experiments/threaded_clustering_experiments.py
