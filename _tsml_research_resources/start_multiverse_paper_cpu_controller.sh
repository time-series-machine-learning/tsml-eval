...
# Existing Slurm jobs, pending tasks, results, and persistent controller state are
# retained. Known older CPU queue feeders on this login node are stopped first.
