...
from sktime_estimator_evaluation.evaluation.base import BaseEstimatorEvaluator
from sktime_estimator_evaluation.utils.read_results import read_clusterer_result_from_uea_format
...
class ClusterEvaluator(BaseEstimatorEvaluator):
    ...
    ----------
    results_path: str
        The path to the csv ignore-results generated by the estimators.
    evaluation_out_path: str
        The path to output the ignore-results of the evaluation
    experiment_name: str
        The name of the experiment (the directory that stores the ignore-results will be called
        this).
    ...
    def evaluate_csv_data(self, csv_path: str) -> Tuple:
        """Evaluate ignore-results from csv file.

        Parameters
        ----------
        csv_path: str
            Path to csv containing the ignore-results to analyse.
