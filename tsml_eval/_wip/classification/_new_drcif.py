...
WIP clone of the aeon DrCIF classifier for exploring ways of speeding up fit and
predict. Interval-based classifier extracting catch22 features from random intervals
on periodogram and differences representations as well as the base series.
"""
...
from tsml_eval._wip.classification._base_interval_forest import BaseIntervalForest


class NewDrCIF(BaseIntervalForest, BaseClassifier):
    """
    ...
    >>> clf = NewDrCIF(n_estimators=10, random_state=0)
    >>> clf.fit(X, y)
    NewDrCIF(n_estimators=10, random_state=0)
    >>> clf.predict(X)
    ...
    def _get_test_params(cls, parameter_set="default"):
        ...
        parameter_set : str, default="default"
            ...
            NewDrCIF provides the following special sets:
