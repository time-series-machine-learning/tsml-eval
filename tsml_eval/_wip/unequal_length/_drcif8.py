...
from tsml_eval._wip.unequal_length.other.base_interval_forest6 import BaseIntervalForest
...
class DrCIFClassifier(BaseIntervalForest, BaseClassifier):
    ...
    def __init__(
        ...
        if base_estimator is None or isinstance(base_estimator, ContinuousIntervalTree):
            replace_nan = "nan"
        else:
            replace_nan = 0
