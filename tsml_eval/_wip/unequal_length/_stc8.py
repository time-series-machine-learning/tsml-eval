...
from tsml_eval._wip.unequal_length.other._shapelet_transform5 import \
...
class ShapeletTransformClassifier(BaseClassifier):
    ...
    def _fit_stc_shared(self, X, y):
        ...
        self._estimator = _clone_estimator(
            HistGradientBoostingClassifier(max_iter=200) if self.estimator is None else self.estimator,
            self.random_state,
        )
