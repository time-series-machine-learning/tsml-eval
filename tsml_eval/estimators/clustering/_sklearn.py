"""A wrapper for sklearn clusterers."""

__maintainer__ = ["MatthewMiddlehurst"]
__all__ = [
    "SklearnToAeonClusterer",
]
...
class SklearnToAeonClusterer(BaseClusterer):
    """Wrapper for scikit-learn clusterers to use the aeon framework.

    Parameters
    ----------
    clusterer : sklearn BaseEstimator
        A scikit-learn clusterer object.
    ...
    clusterer_ : BaseEstimator
        The fitted scikit-learn clusterer clone.
    """
    ...
    def _fit(self, X):
        ...
        self.clusterer_ = _clone_estimator(self.clusterer, self.random_state)
        self.clusterer_.fit(X)
        self.labels_ = self.clusterer_.labels_

        if hasattr(self.clusterer_, "n_clusters"):
            self.n_clusters = self.clusterer_.n_clusters
        else:
    ...
    def _get_test_params(cls, parameter_set="default"):
        ...
        """
        return {
            "clusterer": KMeans(n_clusters=2, max_iter=5),
        }
