...
from tsml_eval.testing.tests import ALL_TSML_EVAL_MODULES_NO_TESTS

if __name__ == "__main__":
    """Test imports in tsml-eval modules with core dependencies only.

    Imports all modules and catch exceptions due to missing dependencies.
    """
    for module in ALL_TSML_EVAL_MODULES_NO_TESTS:
        try:
